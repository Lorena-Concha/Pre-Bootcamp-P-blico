...
const PersonCard = props => {
    ...
    return (
        <form>
            ...
            <div className='validar'>
            {mail.length < 5 ? <p className='valmessage'>mail invalido</p> : ''}
            </div>
            <div className='formulario'>
            ...
            <div className='validar'>
            {password.length < 8 ? <p className='valmessage'>password invalido</p> : ''}
            </div>
            <div className='formulario'>
            ...
            <div className='validar'>
            {cpassword.length < 8 ? <p className='valmessage'>password invalido</p> : ''}
            </div>
            <div className='validar'>
